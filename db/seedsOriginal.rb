...
car_model2 = CarModel.create(name: 'Prisma LT', year: 2019, car_options: 'Ar Condicionado, central multimídia',
               manufacture: manufacture)
...
Car.create(car_model: car_model2, subsidiary: sub, car_km: 2450, color: 'Branco',
